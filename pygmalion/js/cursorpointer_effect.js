	  ...
	  const canvas = document.querySelector(".cursor--canvas");
		...
		const initCursorHovers = () => {
			const handleCanvasCursorMouseEnter = e => {
				...
				isStuck = true;
				TweenMax.to(innerCursor, 1, {background:'#7999a3', scale:0.25, ease: Expo.easeOut});
			};
			const handleCanvasCursorMouseLeave = () => {
				isStuck = false;
				TweenMax.to(innerCursor, 1, {background:'#7999a3', scale:1, ease: Expo.easeOut});
			};
			const handleBasicCursorMouseEnter = e => {
				TweenMax.to(innerCursor, 1, {background:'#7999a3', scale:2, ease: Expo.easeOut});
			};
